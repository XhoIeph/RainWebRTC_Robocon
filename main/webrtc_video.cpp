 ...
 * 
 * Architecture:
 *   Camera(ISP YUV420 O_UYY_E_VYY) �� H.264 HW Encoder �� esp_peer_send_video()
 *   �� DTLS-SRTP �� RTP/UDP �� Browser RTCPeerConnection
 * 
 * Signaling: HTTP SSE (ESP��Browser) + POST (Browser��ESP)
 */
...
/* ================================================================
 *  SSE (Server-Sent Events) for ESP��Browser signaling
 * ================================================================ */
...
/* ================================================================
 *  POST /webrtc/signal �� Browser��ESP (SDP offer/answer, ICE candidates)
 * ================================================================ */
...
/* ================================================================
 *  Frame Callback �� called from camera task with YUV420 frame
 * ================================================================ */
